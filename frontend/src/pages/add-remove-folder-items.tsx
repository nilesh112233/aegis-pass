...
//     const outletSearch = useOutletSearch();
//     const [checkboxSelectedItems, setCheckboxSelectedItems] = useState<string[]>([])

//     const searchQuery = outletSearch?.searchQuery ?? "";
...
//                     <DialogTitle className="text-2xl font-bold">Add new Folder</DialogTitle>
//                 </DialogHeader>
...
//                                 />
//                             ) : (
//                                 <ItemTableBase data={displayItems} checkBoxColumn={true} checkboxSelectedItems={checkboxSelectedItems} setCheckboxSelectedItems={setCheckboxSelectedItems} />
